...
int main() {
    ...
    // Large pool-backed books must live on the heap — default Windows stacks (~1 MiB)
    // cannot hold OrderBook<65536, 4096> inline.
    auto book = std::make_unique<OrderBook<65536, 4096>>();
    L2BookView l2_view;
