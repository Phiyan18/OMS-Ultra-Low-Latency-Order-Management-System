...
public:
    ...
    std::size_t order_pool_used() const noexcept { return order_pool_.allocated(); }
    std::size_t order_pool_capacity() const noexcept { return order_pool_.capacity(); }
    std::size_t level_pool_used() const noexcept { return level_pool_.allocated(); }
    std::size_t level_pool_capacity() const noexcept { return level_pool_.capacity(); }
